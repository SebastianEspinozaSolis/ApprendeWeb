...
# detalle de evaluacion. Profesor Administrador
@login_required
...
# crear esvaluacion. Administrador Profesor
@login_required
def crear_evaluacion(request):
    asignatura = None
    asignatura_id = request.GET.get('asignatura_id')  # Obtener la asignatura_id 
    if asignatura_id:
...
#editar evaluacion. Administrador Profesor
@login_required
