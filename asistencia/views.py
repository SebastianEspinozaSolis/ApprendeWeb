...
# crear asistencia a partir de una asignatura. Profesor Administrador
@login_required
    ...
    if request.user.perfil.rol in ['profesor', 'administrador']:
        ...
        if request.method == 'POST':
            ...
            for alumno in alumnos:
                ...
                if asistio_value:  # El valor True se enviará si el checkbox está marcado
        ...
        return redirect('asistencia:lista_fechas_asistencia', asignatura_id=asignatura_id)
# editar asistencia del alumno seleccionado. Profesor Administrador
@login_required
...
# lista de asistencia organizada por fecha
@login_required
def lista_fechas_asistencia(request, asignatura_id):
    asignatura = get_object_or_404(Asignatura, id=asignatura_id)
    # Obtener la fecha por el filtro
...
# detalle de asistencia.Apoderado y alumno. se mostrara por alumno y por asignatura
@login_required
...
# lista de asignaturas de alumno. Apoderado y alumno
@login_required
